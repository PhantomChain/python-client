...
from client.exceptions import PhantomHTTPException, PhantomParameterException


def giveup_handler(_):
    raise PhantomHTTPException
...
class Connection(object):
    ...
    def _handle_response(self, response):
        if not response.content:
            raise PhantomHTTPException('No content in response', response=response)
